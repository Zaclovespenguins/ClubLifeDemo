...
pluginManagement {
    ...
    if (System.getenv("BUILT_PRODUCTS_DIR") == null) {
        System.setProperty("BUILT_PRODUCTS_DIR", "/Users/zacharyreyes/Library/Developer/Xcode/DerivedData/ClubLifeSwiftRewrite-fushdfcbtxxvbkbytbtjjeouhfyi/Build/Products/Debug-iphonesimulator")
    }
